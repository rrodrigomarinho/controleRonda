...
public class _Super_Usuario extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("br.com.controleronda.bean.Usuario") == null)
            {
                flash.net.registerClassAlias("br.com.controleronda.bean.Usuario", cz);
            }
        }
        catch (e:Error)
        {
    ...
    private var _internal_conta : String;
    private var _internal_senha : String;
    ...
    [Bindable(event="propertyChange")]
    public function get conta() : String
    {
        return _internal_conta;
    }
    ...
    public function set conta(value:String) : void
    {
        var oldValue:String = _internal_conta;
        if (oldValue !== value)
        {
            _internal_conta = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "conta", oldValue, _internal_conta));
        }
    }

    public function set senha(value:String) : void
    {
        var oldValue:String = _internal_senha;
        if (oldValue !== value)
        {
            _internal_senha = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "senha", oldValue, _internal_senha));
        }
    }
