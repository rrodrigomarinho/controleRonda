 ...
 * of this service wrapper you may modify the generated sub-class of this class - RondaControle.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_RondaControle extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_RondaControle()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.Ronda._initRemoteClassAlias();
        ...
        operation = new mx.rpc.remoting.Operation(null, "consultar");
         operation.resultType = valueObjects.Ronda;
        operations["consultar"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "listar");
         operation.resultElementType = valueObjects.Ronda;
    ...
    /**
      ...
      */
    public function excluir(arg0:valueObjects.Ronda) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function alterar(arg0:valueObjects.Ronda) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function incluir(arg0:valueObjects.Ronda) : mx.rpc.AsyncToken
    {
