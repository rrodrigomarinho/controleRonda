 ...
 * of this service wrapper you may modify the generated sub-class of this class - ParametroSistemaControle.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_ParametroSistemaControle extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_ParametroSistemaControle()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.ParametroSistema._initRemoteClassAlias();

        var operations:Object = new Object();
        var operation:mx.rpc.remoting.Operation;

        operation = new mx.rpc.remoting.Operation(null, "listar");
         operation.resultElementType = valueObjects.ParametroSistema;
        ...
        operation = new mx.rpc.remoting.Operation(null, "consultar");
         operation.resultType = valueObjects.ParametroSistema;
    ...
    {
        destination = "parametroSistemaControle";
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function alterar(arg0:int, arg1:String, arg2:String) : mx.rpc.AsyncToken
    {
