 ...
 * of this service wrapper you may modify the generated sub-class of this class - UsuarioControle.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_UsuarioControle extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_UsuarioControle()
    {
        ...
        operation = new mx.rpc.remoting.Operation(null, "autenticarUsuario");
    ...
    /**
      ...
      */
    public function incluir(arg0:valueObjects.Usuario) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function autenticarUsuario(arg0:String, arg1:String) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function alterar(arg0:valueObjects.Usuario) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function excluir(arg0:valueObjects.Usuario) : mx.rpc.AsyncToken
    {
