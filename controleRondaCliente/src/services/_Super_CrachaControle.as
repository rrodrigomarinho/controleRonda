 ...
 * of this service wrapper you may modify the generated sub-class of this class - CrachaControle.as.
 */
package services
{
...
[ExcludeClass]
internal class _Super_CrachaControle extends com.adobe.fiber.services.wrapper.RemoteObjectServiceWrapper
{

    // Constructor
    public function _Super_CrachaControle()
    {
        // initialize service control
        _serviceControl = new mx.rpc.remoting.RemoteObject();

        // initialize RemoteClass alias for all entities returned by functions of this service
        valueObjects.Cracha._initRemoteClassAlias();

        var operations:Object = new Object();
        var operation:mx.rpc.remoting.Operation;

        operation = new mx.rpc.remoting.Operation(null, "listar");
         operation.resultElementType = valueObjects.Cracha;
        operations["listar"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "alterar");
        operations["alterar"] = operation;
        operation = new mx.rpc.remoting.Operation(null, "consultarUltimoCracha");
         operation.resultType = String;
        operations["consultarUltimoCracha"] = operation;
        ...
        operation = new mx.rpc.remoting.Operation(null, "consultar");
         operation.resultType = valueObjects.Cracha;
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function alterar(arg0:valueObjects.Cracha) : mx.rpc.AsyncToken
    {
    ...
    /**
      * This method is a generated wrapper used to call the 'consultarUltimoCracha' operation. It returns an mx.rpc.AsyncToken whose 
      * result property will be populated with the result of the operation when the server response is received. 
      * To use this result from MXML code, define a CallResponder component and assign its token property to this method's return value. 
      * You can then bind to CallResponder.lastResult or listen for the CallResponder.result or fault events.
      *
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function consultarUltimoCracha() : mx.rpc.AsyncToken
    {
        var _internal_operation:mx.rpc.AbstractOperation = _serviceControl.getOperation("consultarUltimoCracha");
		var _internal_token:mx.rpc.AsyncToken = _internal_operation.send() ;
        return _internal_token;
    }
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function incluir(arg0:valueObjects.Cracha) : mx.rpc.AsyncToken
    {
    ...
    /**
      ...
      * @return an mx.rpc.AsyncToken whose result property will be populated with the result of the operation when the server response is received.
      */
    public function excluir(arg0:valueObjects.Cracha) : mx.rpc.AsyncToken
    {
